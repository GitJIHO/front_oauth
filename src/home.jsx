...
function Home() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>홈페이지</h1>
      <div style={styles.buttonContainer}>
        <button style={styles.button} onClick={handleKakaoLogin}>
          <img
        ...
        <button style={styles.button} onClick={handleNaverLogin}>
          <img
            src="https://mtis.komsa.or.kr/images/sns/naver_login.png"
            alt="네이버 로그인"
